...
namespace OpenAI_chat
{
    internal class Program
    {
        ...
        private static async Task BotOnMessageReceived(ITelegramBotClient botClient, Message message)
        {
            ...
            var api = new OpenAIClient(new OpenAIAuthentication("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"));
            ...
            if (message.Text.ToLower().Contains("image"))
            {
                ...
                await botClient.SendTextMessageAsync(message.Chat.Id, imageURLS[0].ToString());
            }
        }
